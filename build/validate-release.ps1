...
function Test-PackageArchive {
    ...
    try {
        ...
        foreach ($required in @('README.md', 'CHANGELOG.md', 'ROADMAP.md', 'SECURITY.md', 'docs/user-manual.md', 'docs/dedicated-server.md', 'docs/upgrade-from-v1.4.3.md', 'docs/troubleshooting.md', 'docs/releases/v2.0.0-rc.1.md', 'docs/validation/release-checklist.md', 'docs/validation/release-matrix.json', 'docs/validation/2026-08-30-windows-smoke.md', 'docs/validation/2026-08-31-linux-smoke.md', 'docs/validation/2026-08-31-authentication-audit.md', 'docs/validation/2026-08-31-exact-rc-runtime.md', 'build/runtime/README.md', 'build/runtime/install-dedicated-package.ps1', 'build/runtime/run-windows-dedicated.ps1', 'build/runtime/run-linux-dedicated.sh', 'build/runtime/analyze-runtime-logs.ps1', 'SHA256SUMS')) {
